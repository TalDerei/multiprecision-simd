...
pub fn bigint_to_biguint<const N: usize, const B: u32>(val: &BigInt<N, B>) -> BigUint {
...
pub fn biguint_to_bigint<const N: usize, const B: u32>(val: &BigUint) -> BigInt<N, B> {
    let mut res = [0u32; N];
...
pub fn bigint_to_hex<const N: usize, const B: u32>(v: &BigInt<N, B>) -> String {
